...
public class frmNhanVien extends javax.swing.JFrame {
    ...
    public void loadData() {
        ...
        Object[] tittle = {"Họ tên","Ngày sinh","Địa chỉ","Giới tính","Phòng ban","Hệ số lương","Thâm niên","Lương cơ bản"};
        model.setColumnIdentifiers(tittle);
        for (NhanVien nhanVien : danhSachNhanVien) {
            Object[] row = new Object[]{nhanVien.getHoTen(),nhanVien.getNgaySinh(),nhanVien.getDiaChi(),nhanVien.getGioiTinh()
            ,nhanVien.getPhongBan(),nhanVien.getHeSoLuong(),nhanVien.getThamNien(),nhanVien.getLuongCoBan()};
            model.addRow(row);
        } 
